...
from src.LFS_GUI.views import (MainWindow, LoginWindow)
from src.LFS_GUI.views.ui_components.animations import create_opacity_animation, create_animation_group
