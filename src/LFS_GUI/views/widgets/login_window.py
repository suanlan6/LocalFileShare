...
from src.LFS_GUI.views.ui_components import apply_shadow_effect
from src.LFS_GUI.views.ui_designs import Ui_Login
...
class LoginWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.progress.text_color = QColor("#000000")
